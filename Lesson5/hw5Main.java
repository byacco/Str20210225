...
class hw5Main {
    ...
    public static void main(String[] args) {
        ...
        hw5Dawg dog = new hw5Dawg("Dog", 20, 20, 70, 40, true);
        hw5Horse horse = new hw5Horse("Horce", 500, 1000, 500, 30, true);
        hw5Bird bird = new hw5Bird("bird", 30, 10, 1, 20, false) {
            @Override
            void Swim() {
                System.out.println("I can't!");
            }
        };
        hw5Cat cat = new hw5Cat("Cat", 15, 10,8, 50, true);

      dog.Jump(20,70, 0.5f);
      horse.Jump(500,500, 3f);
      cat.Swim();
      dog.Swim(20,20,10);
      bird.Swim();
