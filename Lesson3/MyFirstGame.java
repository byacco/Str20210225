...
/*
 TODO
  1. Переписать условия победы так чтобы в поле меньше чем 5х5 выигрышный блок был равен длинне поля,
   добавить запрос на указание длинны поля;
  2. Переписать запрос регистрации игроков так, чтобы при вводе пустого поля на место неназванного игрока
   подключался искуственный идиот;
  3. Запилить искуственного идиота по лагоритму MiniMax или Montecarlo с тремя уровнями сложности;
*/
